...
public class SysRoleController {
    ...
    public RestfulApiResponse<Integer> add(SysRole sysRole) {
        return RestfulApiResponse.success("",  sysRoleService.save(sysRole));
    }

    @ApiOperation("")
    @RequestMapping(value = "delete", method = RequestMethod.DELETE)
    public RestfulApiResponse<Integer> delete(@RequestParam String id) {
        return RestfulApiResponse.success("", sysRoleService.deleteById(id));
    }

    @ApiOperation("")
    @RequestMapping(value = "update", method = RequestMethod.PUT)
    public RestfulApiResponse<Integer>  update(SysRole sysRole) {

            return RestfulApiResponse.success("", sysRoleService.update(sysRole));
    }

    @ApiOperation("")
    @RequestMapping(value = "detail", method = RequestMethod.GET)
    public RestfulApiResponse<SysRole> detail(@RequestParam Integer id) {
            return RestfulApiResponse.success("", sysRoleService.findById(id));
    }
    @ApiOperation("")
